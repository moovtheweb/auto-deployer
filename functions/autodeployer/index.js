...
function deployFunction (archive, name) {
  ...
  console.log(`projects/${PROJECT_ID}/locations/${config.location}`);
  console.log(`gs://${config.stageBucket}/${path.parse(archive).base}`);
  console.log(`projects/${PROJECT_ID}/locations/${config.location}/functions/${name}`);
  return getClient()
    .then((_gcf) => {
      gcf = _gcf;
